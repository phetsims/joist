...
import RelaxedManualConstraint from '../../scenery/js/layout/constraints/RelaxedManualConstraint.js';
  ...
  public constructor( sim: Sim, tandem: Tandem ) {
    ...
    if ( sim.simScreens.length === 1 ) {
      ...
      buttons = new Node( {
        ...
        labelTagName: 'h2',
        labelContent: JoistStrings.a11y.translatable.simScreensStringProperty,
    ...
    const simResourcesContainer = new Node( {
      ...
      labelTagName: 'h2',
      labelContent: JoistStrings.a11y.translatable.simResourcesStringProperty,
      pdomOrder: [
