 ...
 * @constructor
 */
function HomeScreenButton( screen, homeScreenModel, options ) {
  options = merge( {
    cursor: 'pointer',
  ...
  this.addInputListener( { focus: function() { !isSelectedProperty.value && fireListener.fire( null ); } } );
...
export default inherit( VBox, HomeScreenButton );