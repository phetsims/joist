...
define( function( require ) {
  ...
  var NavigationBarScreenButtonIO = require( 'JOIST/NavigationBarScreenButtonIO' );
  ...
  function NavigationBarScreenButton( navigationBarFillProperty, screenIndexProperty, screens, screen, navBarHeight, options ) {
    ...
    options = _.extend( {
      ...
      phetioType: NavigationBarScreenButtonIO,
    ...
    this.buttonModel = new PushButtonModel( {
      listener: clicked,
      tandem: options.tandem // Note it shares a tandem with this, so the emitter will be instrumented as a child of the button
    } );
