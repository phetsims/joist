...
const checkNamespaces = function() {
  ...
  const defined = ( window.requirejs && window.requirejs._defined ) || ( window.require && window.require.s && window.require.s.contexts._.defined );
...
export default checkNamespaces;