...
define( function( require ) {
  ...
  function HomeScreenView( sim, options ) {
    ...
    var screenChildren = _.map( sim.screens, function( screen ) {
      ...
      TScreenButton && options.tandem && options.tandem.createTandem( screen.tandem.tail + 'LargeButton' ).addInstance( largeScreenButton, TScreenButton );
      ...
      TScreenButton && options.tandem && options.tandem.createTandem( screen.tandem.tail + 'SmallButton' ).addInstance( smallScreenButton, TScreenButton );
